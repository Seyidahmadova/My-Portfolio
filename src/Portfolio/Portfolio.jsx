      ...
      <div className="portfolio-container">
        ...
        <div className="portfolio-detail">
          <div className="portfolio-item">
            ...
            <div className="portfolio-link">
              ...
              <div className="portfolio-demo">
                <a href="https://main--resilient-ganache-deb5dc.netlify.app/">
                  Live Demo
                </a>
              </div>
            </div>
          ...
          <div className="portfolio-item">
            ...
            <div className="portfolio-link">
              <div className="portfolio-github">
                <a href="https://github.com/Seyidahmadova/Currency-Converter">
                  Github
                </a>
              </div>
              <div className="portfolio-demo">
                <a href="https://main--tubular-rolypoly-9734a8.netlify.app/">
                  Live Demo
                </a>
              </div>
            </div>
          ...
          <div className="portfolio-item">
            ...
            <div className="portfolio-link">
              <div className="portfolio-github">
                <a href="https://github.com/Seyidahmadova/To-Do-List-1.2.0">
                  Github
                </a>
              </div>
              <div className="portfolio-demo">
                <a href="https://fanciful-frangipane-4e5d42.netlify.app/">
                  Live Demo
                </a>
              </div>
            </div>
          ...
          <div className="portfolio-item">
            ...
            <div className="portfolio-link">
              <div className="portfolio-github">
                <a href="https://github.com/Seyidahmadova/Movie-search">
                  Github
                </a>
              </div>
              <div className="portfolio-demo">
                <a href="https://main--incomparable-duckanoo-d3ae00.netlify.app/">
                  Live Demo
                </a>
              </div>
            </div>
          ...
          <div className="portfolio-item">
            ...
            <div className="portfolio-link">
              <div className="portfolio-github">
                <a href="https://github.com/Seyidahmadova/Roll-the-Dice">
                  Github
                </a>
              </div>
              <div className="portfolio-demo">
                <a href="https://main--aesthetic-licorice-23c457.netlify.app/">
                  Live Demo
                </a>
              </div>
            </div>
